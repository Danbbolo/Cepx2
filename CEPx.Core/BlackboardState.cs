...
public readonly struct BlackboardState
{
    ...
    public readonly double ReversalScore;
    ...
    public BlackboardState(long timestamp, string symbol, bool sweepActive, string patternFamily, double patternSimilarity, double reversalScore, double kalmanVelocity, double uncertaintyUpper, double uncertaintyLower, double anomalyScore, string regime, double regimeConfidence, string lastAction)
    {
        Timestamp = timestamp;
        Symbol = symbol;
